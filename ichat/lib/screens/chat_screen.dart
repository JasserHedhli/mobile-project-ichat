...
class _ChatScreenState extends State<ChatScreen> {
  ...
  //file extensions
  String? fileTypeChoose;

  //for handling message changes
  final _textController = TextEditingController();

  //_showEmoji for storing value of showing or not emojis
  //_isUploading cheking if image uploaded or not
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: SafeArea(
        child: WillPopScope(
          //if emojis are shown and back button is pressed then close emojis
          ...
          child: Scaffold(
            ...
            body: Column(
              children: [
                ...
                //for showing progress uploading image
                if (_isUploading)
                  const Align(
                    ...
                    onPressed: () async {
                      ...
                      if (result != null && result.files.isNotEmpty) {
                        ...
                        for (var file in result.files) {
                          ...
                          await APIs.sendFile(widget.user, File(file.path!));
